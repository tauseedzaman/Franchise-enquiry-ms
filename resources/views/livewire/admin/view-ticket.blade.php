<main>
    <div class="container" wire:poll.60000ms>
            ...
            <div class="col-sm-10">
                <h1 class=""><b>Ticket  #{{ $ticket->id }}</b></h1>
            </div>
            <div class="col-sm-2 text-right float-right ">
                    <a href="{{ route("admin.tickets") }}" class="btn btn-primary float-right"><b>Return To
                        Tickets</b></a>
            </div>
        </div>
                ...
                <div class="card shadow-lg border-0 rounded-lg mt-2">
                    <div class="card-header border-bottom bg-light">
                        <div class="row d-flex align-items-center justify-content-around ">
                            ...
                            <div class="col-sm-4 flex align-items-right text-center ">
                                ...
                                <button class="btn btn-outline-dark ml-2" type="button"
                                    ...
                                    wire:click="show_this_ticket()">Close</button>
                            </div>
                        </div>
                    </div>
                    @if ($show_reply_form)
                    ...
                    <div class="row my-2">
                        <div class="col-9">
                            <h4 class="text-success pl-3 p-3"><b>{{ $TicketReply->user->name }}</b></h4>
                        </div>
                        <div class="col-3 text-center p-3 float-right text-right">
