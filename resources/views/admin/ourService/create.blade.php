...
@section('page') Our Service @endsection
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row p-5" style="margin: 10px">
                        <div class="col p-5">
                            <form action="{{ route("admin.our.service.store") }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8" class=" border-2  rounded p-3" >
                            @csrf
                                <h3 class="text-capitalize text-info p-2  mb-3 text-center text-lg rounded" >{{ __("Add Our Service") }}</h3>
                            ...
                            Only the latest active Our Service will be displayed on <a href="{{ route("our.services") }}" target="__blenk">Mobile Work Demo </a> Page
                            </div>
