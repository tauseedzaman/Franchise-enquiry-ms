...
@section('page') Edit Our Service  @endsection
    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row p-2" style="">
                        <div class="col p-2">
                            <form action="{{ route('admin.our.service.update',$post->id    ) }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8" class=" border-2  rounded p-3" >
                            @csrf
                                <h3 class="text-capitalize text-info p-2  mb-3 text-center text-lg rounded" >{{ __("Edit Our Service") }}</h3>
                            <div class="form-group">
                                <label for="Title">Title</label>
                                <input type="text" class="form-control" name="title" value="{{ $post->title }}" placeholder="Service Title">
