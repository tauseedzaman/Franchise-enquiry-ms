    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row p-5" style="margin: 10px">
                        <div class="col p-5">
                            <form action="{{ route("admin.field.work.demo.store") }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8" class=" border-2  rounded p-3" >
                            @csrf
                                <h3 class="text-capitalize text-info p-2  mb-3 text-center text-lg rounded" >{{ __("Add Field Work Demo") }}</h3>
                            <div class="form-group">
                                <label for="Title">Title</label>
                                <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Demo Title">
                                @error('title') <span class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
                            </div>

                            <div class="form-group mt-3">
                                <label for="status">Demo Status</label>
                            ...
                            Only the latest active Demo will be displayed on <a href="{{ route("form.field.Work.demo") }}" target="__blenk">Field Work Demo </a> Page
                            </div>

                            <div class="form-group">
                                <label for="content">Demo Description</label>
