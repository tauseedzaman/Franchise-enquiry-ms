    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row p-5" style="margin: 10px">
                        <div class="col p-5">
                            <form action="{{ route("admin.AdPostingDemo.store") }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8" class=" border-2  rounded p-3" >
                            @csrf
                                <h3 class="text-capitalize text-info p-2  mb-3 text-center text-lg rounded" >{{ __("Add New Ad Posting Demo") }}</h3>
                            ...
                            Only the latest active Demo will be displayed on <a href="{{ route("Ad.posting.Demo") }}" target="__blenk">ad's Posting Demo </a> Page
                            </div>
