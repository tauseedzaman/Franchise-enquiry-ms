    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row p-5" style="margin: 10px">
                        <div class="col p-5">
                            <form action="{{ route("admin.systemWork.store") }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8" class=" border-2  rounded p-3" >
                            @csrf
                                <h3 class="text-capitalize text-info p-2  mb-3 text-center text-lg rounded" >{{ __("Add New System Work Content") }}</h3>
                                <br>
                            ...
                            Only the latest active record will be displayed on <a href="{{ route("System.Work") }}" target="__blenk">System Work  </a> Page
                            </div>
                            <br>
