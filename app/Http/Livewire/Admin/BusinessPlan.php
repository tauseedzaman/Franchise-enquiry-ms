...
use App\Models\businessPlan as ModelsBusinessPlan;
...
class BusinessPlan extends Component
{
    ...
    public function update($id)
    {
        ...
        $content = ModelsBusinessPlan::findOrFail($id);
    ...
    {
        $record = ModelsBusinessPlan::findOrFail($id);
    ...
    public function render()
    {
        return view('livewire.admin.business-plan',[
            "posts" => ModelsBusinessPlan::latest()->paginate(20)
